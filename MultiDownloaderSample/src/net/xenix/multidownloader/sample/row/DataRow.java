package net.xenix.multidownloader.sample.row;

import net.xenix.lib.multidownload.data.XCDownloadData;
import net.xenix.multidownloader.sample.R;
...
public class DataRow extends FrameLayout {
	...
	private XCDownloadData mDownloadData;
	...
	public void setData(XCDownloadData data) {
		mDownloadData = data;
	...
	private OnClickListener mClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.row_data_Button:
				if ( mDelegate != null ) {
					mDelegate.onClickButton(mDownloadData);
				}
				break;
			}
		}
